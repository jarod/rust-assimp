...
extern {
    ...
    /// * `hint` An additional hint to the library. If this is a non empty string,
    ...
    ///     unsigned int pFlags,
    ///     const char* pHint);
    fn aiImportFileFromMemory(buf: *const c_char,
                              len: c_uint,
                              flags: c_uint,
                              hint: *const c_char)
                              ->  *const RawScene;
    ...
    ///
    /// * props #aiPropertyStore instance containing import settings.
    /// @see aiImportFileFromMemory
    ///
    fn aiImportFileFromMemoryWithProperties(buf: *const c_char,
                                            len: c_uint,
                                            flags: c_uint,
                                            hint: *const c_char,
    ...
    //     unsigned int pFlags);
    fn aiApplyPostProcessing(scene: *mut RawScene,
                             flags: c_uint)
                             -> *const RawScene;
    ...
    /// 
    fn aiSetImportPropertyString(store: *const PropertyStore,
                                 name: *const c_char,
                                 st: *const AiString);
    ...
    fn aiEnableVerboseLogging(enable: AiBool);
    ...
    fn aiGetMemoryRequirements(scene: *const RawScene, info: *const MemoryInfo);
}
